...
public class IdCardPresenter extends LocationPresenter<IdCardAuthContract.IdCardAuthView, IdCardAuthContract.IdCardAuthModel> {

    public IdCardPresenter(IdCardAuthContract.IdCardAuthView view) {
